...
def get_proxylist(type):
    if type == "SOCKS5":
        ...
        r += requests.get("https://api.openproxylist.xyz/http.txt").text
        r += requests.get("https://sheesh.rip/http").text
        r += requests.get("https://www.proxy-list.download/api/v1/get?type=https").text
        r += requests.get("https://raw.githubusercontent.com/clarketm/proxy-list/master/proxy-list-raw.txt").text
        r += requests.get("https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-http.txt").text
        r += requests.get("https://raw.githubusercontent.com/jetkai/proxy-list/main/online-proxies/txt/proxies-https.txt").text
        r += requests.get("https://raw.githubusercontent.com/saschazesiger/Free-Proxies/master/proxies/http.txt").text
        r += requests.get("https://raw.githubusercontent.com/rx443/proxy-list/main/online/all.txt").text
        r += requests.get("https://raw.githubusercontent.com/UptimerBot/proxy-list/main/proxies/http.txt").text
        r += requests.get("https://raw.githubusercontent.com/UptimerBot/proxy-list/main/proxies_anonymous/http.txt").text
        r += requests.get("https://raw.githubusercontent.com/MuRongPIG/Proxy-Master/main/http.txt").text
        r += requests.get("https://raw.githubusercontent.com/mython-dev/free-proxy-4000/main/proxy-4000.txt").text
        r += requests.get("https://proxyspace.pro/http.txt").text
        r += requests.get("https://proxyspace.pro/https.txt").text
        r += requests.get("https://proxyspace.pro/socks5.txt").text
        r += requests.get("https://raw.githubusercontent.com/monosans/proxy-list/main/proxies/socks5.txt").text
        r += requests.get("https://raw.githubusercontent.com/monosans/proxy-list/main/proxies_anonymous/socks5.txt").text
        r += requests.get("https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/socks5.txt").text
        r += requests.get("https://raw.githubusercontent.com/roosterkid/openproxylist/main/SOCKS5_RAW.txt").text
        r += requests.get("https://raw.githubusercontent.com/TheSpeedX/PROXY-List/master/http.txt").text
        r += requests.get("https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/http.txt").text
        r += requests.get("https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/https.txt").text
        r += requests.get("https://raw.githubusercontent.com/monosans/proxy-list/main/proxies/http.txt").text
        r += requests.get("https://raw.githubusercontent.com/hookzof/socks5_list/master/proxy.txt").text
...
def help():
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"plans   "+Fore.LIGHTCYAN_EX+" |"+Fore.LIGHTWHITE_EX+" Show plans                             "+Fore.LIGHTCYAN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Exit Panel                             "+Fore.LIGHTCYAN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"THANK    "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" thanks for buying and using botnet     "+Fore.LIGHTCYAN_EX+"║\n")
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Owner    "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" @Tcpczxz       "+Fore.LIGHTCYAN_EX+"                        ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def plans():
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╗\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Plan Basic "+Fore.RED+": \x1b[38;2;0;255;189m300sec maxtime | con: 1 | vip: false | 1 month\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Plan Vip"+Fore.RED+": \x1b[38;2;0;255;189m    600sec maxtime | con: 2 | vip: true | 1 month\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Addons "+Fore.RED+": \x1b[38;2;0;255;189m    Dm Telegram Me\n")
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
...
def title():
    stdout.write("                                                                                          \n")
    stdout.write("                      "+Fore.LIGHTWHITE_EX  +" _____            _                        __   __                  \n")
    stdout.write("                      "+Fore.LIGHTCYAN_EX   +"/ ____|          | |                       \ \ / /                 \n")
    stdout.write("                      "+Fore.LIGHTCYAN_EX   +"| |       _   _  | |__     ___   _ __       \ V /                  \n")
    stdout.write("                      "+Fore.LIGHTWHITE_EX  +"| |      | | | | | '_ \   / _ \ | '__|       > <                   \n")
    stdout.write("                      "+Fore.LIGHTWHITE_EX  +"| |____  | |_| | | |_) | |  __/ | |         / . \                  \n")
    stdout.write("                      "+Fore.LIGHTWHITE_EX  +"\_____|  \__,| |   .__/   \___| |_|        /     \                     ")
    stdout.write("                      "+Fore.LIGHTWHITE_EX  +"                    __/ |                                                               ")
    stdout.write("                      "+Fore.LIGHTWHITE_EX  +"           |___/                                        \n")
    stdout.write("                                                                                         \n")
    stdout.write("                                                                                         \n")
    stdout.write("                                                                                         \n")
    stdout.write("                        "+Fore.LIGHTCYAN_EX            +"       Cyber X v2.1 update methods + update panel\n")
    stdout.write("                        "+Fore.LIGHTCYAN_EX            +"     ╚════╦═════════════════════════════════╦══════╝\n")
    stdout.write("                        "+Fore.LIGHTCYAN_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("                        "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"                 Welcome To Cyber X  "+Fore.LIGHTCYAN_EX  +"               ║\n")
    stdout.write("                        "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"     Powerful l4 or l7 Bypass - Owner : @Tcpczxz    "+Fore.LIGHTCYAN_EX +"║\n")
    stdout.write("                        "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"           Contact Buy C2 / Botnet @Tcpczxz   "+Fore.LIGHTCYAN_EX +"      ║\n")
    stdout.write("                        "+Fore.LIGHTCYAN_EX+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTCYAN_EX+"╔═══"+Fore.LIGHTCYAN_EX+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTCYAN_EX+"CYBER X"+Fore.CYAN+"]"+Fore.LIGHTCYAN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
...
#    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"stellar    "+Fore.RED+": "+Fore.WHITE+"HTTPS Sky method without proxies\n")
    ...
    stdout.write(Fore.MAGENTA+" • "+Fore.WHITE+"plans     "+Fore.RED+": "+Fore.WHITE+"Thanks for\n")
